          ...
          <div className="flex justify-center">
            <div className="lg:flex lg:justify-center md:flex md:justify-center my-16 lg:gap-10 md:gap-5  ">
              <motion.div
                ...
                className={
                  context.theme
                    ? "lg:w-[280px] lg:h-[300px] md:w-[200px] md:h-[280px] w-[250px] h-[280px] bg-gray-200 hover:bg-gray-300 duration-500 lg:p-10 p-10 my-10 rounded-2xl"
                    : "lg:w-[280px] lg:h-[300px] md:w-[200px] md:h-[280px] w-[250px] h-[280px] bg-[#2E2E2E] hover:bg-[#454545] duration-500 lg:p-10 p-10 my-10 rounded-2xl"
                }
              >
                ...
                <h1
                  className={
                    context.theme
                      ? "my-10 lg:text-2xl text-blue-900 lg:w-[150px] duration-500"
                      : "my-10 lg:text-2xl text-slate-200 lg:w-[150px] duration-500"
                  }
                >
                  UI/UX Integrator
                </h1>
                <span
                  ...
                  className={
                    context.theme
                      ? "text-purple-800 hover:text-white duration-300 cursor-pointer"
                      : "text-slate-200 hover:text-orange-500 duration-300 cursor-pointer"
                  }
                >
                  Read More
                  <ArrowRightAlt />
